...
public class Day11Test extends DayTest {
  ...
  @Test
  public void should_compute_next_step_when_no_blink() throws URISyntaxException, IOException {
    Day11 day = new Day11();
    int[][] before =
        new int[][] {
          {5, 4, 8, 3, 1, 4, 3, 2, 2, 3},
  ...
  @Test
  public void should_compute_next_step_when_blinks() throws URISyntaxException, IOException {
    Day11 day = new Day11();
    int[][] before =
        new int[][] {
          {6, 5, 9, 4, 2, 5, 4, 3, 3, 4},
